...
<body class="bg-orbita-light text-gray-900 antialiased flex flex-col min-h-screen">
    ...
    {{-- 4. FOOTER --}}
    <footer class="bg-orbita-blue text-white pt-24 pb-10 relative overflow-hidden mt-auto border-t border-orbita-gold/20">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20 border-b border-white/5 pb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium text-gray-400">
                        ...
                        <li><a href="{{ route('policy.installation') }}" class="hover:text-white transition">Installation Guide</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium text-gray-400">
                        ...
                        <li><a href="{{ route('policy.warranty') }}" class="hover:text-white transition">Warranty Policy</a></li>
                        <li><a href="{{ route('catalog.download') }}" class="hover:text-orbita-gold transition font-bold italic">Download Catalog (PDF)</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    {{-- 📧 SUBSCRIPTION FORM --}}
                    <form action="{{ route('subscribe.store') }}" method="POST" class="relative group">
                        @csrf
                        <input type="email" name="email" required placeholder="Email Address" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-xs focus:ring-1 focus:ring-orbita-gold outline-none text-white transition-all group-hover:border-white/20">
                        <button type="submit" class="absolute right-1 top-1 bottom-1 bg-orbita-gold text-orbita-blue px-4 rounded-lg font-bold text-[10px] uppercase tracking-widest hover:bg-white transition-colors">Join</button>
                    </form>
                    <p class="text-[9px] text-gray-500 mt-3 uppercase tracking-tighter">Subscribe for monthly tech updates</p>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-500 font-bold uppercase tracking-widest">
                ...
                <div class="my-4 md:my-0">
                    <a href="/admin" class="text-gray-600/30 hover:text-orbita-gold/50 transition-colors cursor-default hover:cursor-pointer">System Access</a>
                </div>
    ...
    {{-- Popups (Should be at end of body) --}}
